...
void Kmeans::KMeans(Mat& img, vector<vector<int>>& centroids, vector<int>& labels, int n_clusters, int max_iter) {
...
Mat Kmeans::segment(Mat& img, vector<vector<int>>& centroids, vector<int>& labels) {
